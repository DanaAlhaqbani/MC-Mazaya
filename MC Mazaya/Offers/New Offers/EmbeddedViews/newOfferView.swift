...
class newOfferView: UIViewController ,UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.addressLabel.text = offer?.offersDetails
        cell.servicetype.text = ("نوع الخدمة:" + (offer?.serviceType ?? ""))
