...
let googleApiKey = "AIzaSyDGvP3Wh5bJJludGyjdDq1NNki4qLJikFY"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationBarAppearace.barTintColor = UIColor(rgb: 0x26998a)
        navigationBarAppearace.tintColor = .white
        // Make back button with image and without title
        //Custom back button
        ...
        barButtonItemAppearance.setBackButtonBackgroundVerticalPositionAdjustment(-10, for: .default)
        let image = UIImage()
